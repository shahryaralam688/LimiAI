...
struct StaticLightARViewContainer: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> ARView {
        ...
        // Resolve source URL: downloaded file if present, else bundled fallback
        let sourceURL: URL = {
            ...
            guard let fallback = Bundle.main.url(
                ...
                fatalError("Could not find mount1.usdz in art.scnassets and no downloaded model present")
            }
            return fallback
        }()
