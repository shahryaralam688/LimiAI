...
struct NonARModelView: UIViewRepresentable {
    ...
    private func loadModel(into arView: ARView, context: Context) {
        ...
        guard let modelURL = finalURL else {
        ...
        do {
            ...
            print("❌ NonARModelView: Failed to load model: \(error)")
        }
    }
}
